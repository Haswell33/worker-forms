...
function getWorkerDocTemplate() {return DriveApp.getFileById('<google_doc_id>') } // doc template for worker forms
...
function getEmploymentDocTemplate() {return DriveApp.getFileById('<google_doc_id>') } // doc template for employment forms
